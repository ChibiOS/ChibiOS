 ...
 *
 * @page oslib_test_sequence_006 [6] Memory Pools
 *
...
/**
 * @page oslib_test_006_001 [6.1] Loading and emptying a memory pool
 *
 * <h2>Description</h2>
...
/**
 * @page oslib_test_006_002 [6.2] Loading and emptying a guarded memory pool without waiting
 *
 * <h2>Description</h2>
 * The memory pool functionality is tested by loading and emptying it,
 * all conditions are tested.
...
static void oslib_test_006_002_setup(void) {
...
#if (CH_CFG_USE_SEMAPHORES) || defined(__DOXYGEN__)
/**
 * @page oslib_test_006_003 [6.3] Guarded Memory Pools timeout
 *
 * <h2>Description</h2>
...
static void oslib_test_006_003_setup(void) {
  chGuardedPoolObjectInit(&gmp1, sizeof (uint32_t));
}

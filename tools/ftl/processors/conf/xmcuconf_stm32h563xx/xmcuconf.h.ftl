 ...
 */
#define STM32_RTC_GLOBAL_IRQ_PRIORITY       ${doc.STM32_RTC_GLOBAL_IRQ_PRIORITY!"STM32_IRQ_EXTI17_PRIORITY"}
#define STM32_RTC_TAMP_IRQ_PRIORITY         ${doc.STM32_RTC_TAMP_IRQ_PRIORITY!"STM32_IRQ_EXTI19_PRIORITY"}

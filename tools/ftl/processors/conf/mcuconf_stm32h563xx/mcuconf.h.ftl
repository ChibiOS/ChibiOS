...
#define STM32_ADC_ADC1_GPDMA_CHANNEL        ${doc.STM32_ADC_ADC1_GPDMA_CHANNEL!"STM32_GPDMA1_MASK_FIFO2"}
#define STM32_ADC_ADC2_GPDMA_CHANNEL        ${doc.STM32_ADC_ADC2_GPDMA_CHANNEL!"STM32_GPDMA2_MASK_FIFO2"}
...
#define STM32_SPI_SPI1_RX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI1_RX_GPDMA_CHANNEL!"STM32_GPDMA1_MASK_FIFO2"}
#define STM32_SPI_SPI1_TX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI1_TX_GPDMA_CHANNEL!"STM32_GPDMA1_MASK_FIFO2"}
#define STM32_SPI_SPI2_RX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI2_RX_GPDMA_CHANNEL!"STM32_GPDMA2_MASK_FIFO2"}
#define STM32_SPI_SPI2_TX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI2_TX_GPDMA_CHANNEL!"STM32_GPDMA2_MASK_FIFO2"}
#define STM32_SPI_SPI3_RX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI3_RX_GPDMA_CHANNEL!"STM32_GPDMA1_MASK_FIFO2"}
#define STM32_SPI_SPI3_TX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI3_TX_GPDMA_CHANNEL!"STM32_GPDMA1_MASK_FIFO2"}
#define STM32_SPI_SPI4_RX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI4_RX_GPDMA_CHANNEL!"STM32_GPDMA2_MASK_FIFO2"}
#define STM32_SPI_SPI4_TX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI4_TX_GPDMA_CHANNEL!"STM32_GPDMA2_MASK_FIFO2"}
#define STM32_SPI_SPI5_RX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI5_RX_GPDMA_CHANNEL!"STM32_GPDMA1_MASK_FIFO2"}
#define STM32_SPI_SPI5_TX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI5_TX_GPDMA_CHANNEL!"STM32_GPDMA1_MASK_FIFO2"}
#define STM32_SPI_SPI6_RX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI6_RX_GPDMA_CHANNEL!"STM32_GPDMA2_MASK_FIFO2"}
#define STM32_SPI_SPI6_TX_GPDMA_CHANNEL     ${doc.STM32_SPI_SPI6_TX_GPDMA_CHANNEL!"STM32_GPDMA2_MASK_FIFO2"}

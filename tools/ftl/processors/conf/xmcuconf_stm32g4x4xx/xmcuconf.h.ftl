...
#define STM32_ADC_ADC5_IRQ_PRIORITY         ${doc.STM32_ADC_ADC5_IRQ_PRIORITY!"5"}
...
#define STM32_ADC_ADC5_DMA_IRQ_PRIORITY     ${doc.STM32_ADC_ADC5_DMA_IRQ_PRIORITY!"5"}
 ...
 */
#define STM32_RTC_TAMP_STAMP_IRQ_PRIORITY   ${doc.STM32_RTC_TAMP_STAMP_IRQ_PRIORITY!"STM32_IRQ_EXTI19_PRIORITY"}
#define STM32_RTC_WKUP_IRQ_PRIORITY         ${doc.STM32_RTC_WKUP_IRQ_PRIORITY!"STM32_IRQ_EXTI20_PRIORITY"}
#define STM32_RTC_ALARM_IRQ_PRIORITY        ${doc.STM32_RTC_ALARM_IRQ_PRIORITY!"STM32_IRQ_EXTI18_PRIORITY"}

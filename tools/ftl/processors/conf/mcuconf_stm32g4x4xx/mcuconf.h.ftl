 ...
 */
#define STM32_SIO_USE_USART1                ${doc.STM32_SERIAL_USE_USART1!"FALSE"}
#define STM32_SIO_USE_USART2                ${doc.STM32_SERIAL_USE_USART1!"FALSE"}
#define STM32_SIO_USE_USART3                ${doc.STM32_SERIAL_USE_USART1!"FALSE"}
#define STM32_SIO_USE_UART4                 ${doc.STM32_SERIAL_USE_USART1!"FALSE"}
#define STM32_SIO_USE_UART5                 ${doc.STM32_SERIAL_USE_USART1!"FALSE"}
#define STM32_SIO_USE_LPUART1               ${doc.STM32_SERIAL_USE_USART1!"FALSE"}

...
#define STM32_PLL2_DIVP_VALUE               ${doc.STM32_PLL2_DIVP_VALUE!"8"}
...
#define STM32_I2C_I2C4_RX_BDMA_CHANNEL      ${doc.STM32_I2C_I2C4_RX_BDMA_CHANNEL!"0"}
#define STM32_I2C_I2C4_TX_BDMA_CHANNEL      ${doc.STM32_I2C_I2C4_TX_BDMA_CHANNEL!"1"}
...
#define STM32_SDC_SDMMC1_DMA_CHANNEL        ${doc.STM32_SDC_SDMMC1_DMA_CHANNEL!"5"}
...
#define STM32_SPI_SPI4_RX_DMA_CHANNEL       ${doc.STM32_SPI_SPI4_RX_DMA_CHANNEL!"12"}
#define STM32_SPI_SPI4_TX_DMA_CHANNEL       ${doc.STM32_SPI_SPI4_TX_DMA_CHANNEL!"13"}
#define STM32_SPI_SPI5_RX_DMA_CHANNEL       ${doc.STM32_SPI_SPI5_RX_DMA_CHANNEL!"12"}
#define STM32_SPI_SPI5_TX_DMA_CHANNEL       ${doc.STM32_SPI_SPI5_TX_DMA_CHANNEL!"13"}
#define STM32_SPI_SPI6_RX_BDMA_CHANNEL      ${doc.STM32_SPI_SPI6_RX_BDMA_CHANNEL!"2"}
#define STM32_SPI_SPI6_TX_BDMA_CHANNEL      ${doc.STM32_SPI_SPI6_TX_BDMA_CHANNEL!"3"}
...
#define STM32_UART_USART1_RX_DMA_CHANNEL    ${doc.STM32_UART_USART1_RX_DMA_CHANNEL!"14"}
#define STM32_UART_USART1_TX_DMA_CHANNEL    ${doc.STM32_UART_USART1_TX_DMA_CHANNEL!"15"}
#define STM32_UART_USART2_RX_DMA_CHANNEL    ${doc.STM32_UART_USART2_RX_DMA_CHANNEL!"8"}
#define STM32_UART_USART2_TX_DMA_CHANNEL    ${doc.STM32_UART_USART2_TX_DMA_CHANNEL!"9"}
#define STM32_UART_USART3_RX_DMA_CHANNEL    ${doc.STM32_UART_USART3_RX_DMA_CHANNEL!"12"}
#define STM32_UART_USART3_TX_DMA_CHANNEL    ${doc.STM32_UART_USART3_TX_DMA_CHANNEL!"13"}
#define STM32_UART_UART4_RX_DMA_CHANNEL     ${doc.STM32_UART_UART4_RX_DMA_CHANNEL!"14"}
#define STM32_UART_UART4_TX_DMA_CHANNEL     ${doc.STM32_UART_UART4_TX_DMA_CHANNEL!"15"}
#define STM32_UART_UART5_RX_DMA_CHANNEL     ${doc.STM32_UART_UART5_RX_DMA_CHANNEL!"8"}
#define STM32_UART_UART5_TX_DMA_CHANNEL     ${doc.STM32_UART_UART5_TX_DMA_CHANNEL!"9"}
#define STM32_UART_USART6_RX_DMA_CHANNEL    ${doc.STM32_UART_USART6_RX_DMA_CHANNEL!"12"}
#define STM32_UART_USART6_TX_DMA_CHANNEL    ${doc.STM32_UART_USART6_TX_DMA_CHANNEL!"13"}
#define STM32_UART_UART7_RX_DMA_CHANNEL     ${doc.STM32_UART_UART7_RX_DMA_CHANNEL!"8"}
#define STM32_UART_UART7_TX_DMA_CHANNEL     ${doc.STM32_UART_UART7_TX_DMA_CHANNEL!"9"}
#define STM32_UART_UART8_RX_DMA_CHANNEL     ${doc.STM32_UART_UART8_RX_DMA_CHANNEL!"12"}
#define STM32_UART_UART8_TX_DMA_CHANNEL     ${doc.STM32_UART_UART8_TX_DMA_CHANNEL!"13"}

...
#if defined(STM32H7A3xx) && !defined(STM32H7A3_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H7A3_XMCUCONF not defined"
#endif

#if defined(STM32H7B3xx) && !defined(STM32H7B3_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H7B3_XMCUCONF not defined"
#endif

#if defined(STM32H7A3xxQ) && !defined(STM32H7A3_Q_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H7A3_Q_XMCUCONF not defined"
#endif

#if defined(STM32H7B3xxQ) && !defined(STM32H7B3_Q_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H7B3_Q_XMCUCONF not defined"
#endif

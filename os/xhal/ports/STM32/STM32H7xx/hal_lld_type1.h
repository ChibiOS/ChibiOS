...
/**
 * @name    Configuration switches to be used in @p xmcuconf.h
 * @{
 */
 ...
 */
#if !defined(STM32H7xx_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H7xx_XMCUCONF not defined"
#endif

#if defined(STM32H750xx) && !defined(STM32H750_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H750_XMCUCONF not defined"
#endif

#if defined(STM32H742xx) && !defined(STM32H742_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H742_XMCUCONF not defined"
#endif

#if defined(STM32H743xx) && !defined(STM32H743_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H743_XMCUCONF not defined"
#endif

#if defined(STM32H753xx) && !defined(STM32H753_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H753_XMCUCONF not defined"
#endif

#if defined(STM32H745xx) && !defined(STM32H745_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H745_XMCUCONF not defined"
#endif

#if defined(STM32H755xx) && !defined(STM32H755_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H755_XMCUCONF not defined"
#endif

#if defined(STM32H747xx) && !defined(STM32H747_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H747_XMCUCONF not defined"
#endif

#if defined(STM32H757xx) && !defined(STM32H757_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32H757_XMCUCONF not defined"
#endif

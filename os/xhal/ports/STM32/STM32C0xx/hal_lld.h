 ...
 */
#if !defined(STM32C0xx_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32C0xx_XMCUCONF not defined"
#endif

#if defined(STM32C011xx) && !defined(STM32C011_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32C011_XMCUCONF not defined"

#elif defined(STM32C031xx) && !defined(STM32C031_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32C031_XMCUCONF not defined"

#elif defined(STM32C051xx) && !defined(STM32C051_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32C051_XMCUCONF not defined"

#elif defined(STM32C071xx) && !defined(STM32C071_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32C071_XMCUCONF not defined"

#elif defined(STM32C091xx) && !defined(STM32C091_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32C091_XMCUCONF not defined"

#elif defined(STM32C092xx) && !defined(STM32C092_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32C092_XMCUCONF not defined"

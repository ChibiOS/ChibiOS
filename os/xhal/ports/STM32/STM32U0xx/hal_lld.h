 ...
 */
#if !defined(STM32U0xx_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32U0xx_XMCUCONF not defined"
#endif

#if defined(STM32U031xx) && !defined(STM32U031_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32U031_XMCUCONF not defined"

#elif defined(STM32U073xx) && !defined(STM32U073_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32U073_XMCUCONF not defined"

#elif defined(STM32U083xx) && !defined(STM32U083_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32U083_XMCUCONF not defined"

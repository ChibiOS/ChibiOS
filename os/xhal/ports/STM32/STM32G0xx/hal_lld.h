 ...
 */
#if !defined(STM32G0xx_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G0xx_XMCUCONF not defined"
#endif

#if defined(STM32G070xx) && !defined(STM32G070_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G070_XMCUCONF not defined"

#elif defined(STM32G031xx) && !defined(STM32G031_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G031_XMCUCONF not defined"

#elif defined(STM32G041xx) && !defined(STM32G041_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G041_XMCUCONF not defined"

#elif defined(STM32G071xx) && !defined(STM32G071_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G071_XMCUCONF not defined"

#elif defined(STM32G081xx) && !defined(STM32G081_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G081_XMCUCONF not defined"

#elif defined(STM32G0B1xx) && !defined(STM32G0B1_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G0B1_XMCUCONF not defined"

#elif defined(STM32G0B0xx) && !defined(STM32G0B0_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G0B0_XMCUCONF not defined"

#elif defined(STM32G0C1xx) && !defined(STM32G0C1_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32G0C1_XMCUCONF not defined"

...
#define RCC_CFGR1_SW_FIELD      STM32_SW_FIELD
#define RCC_CFGR1_SW_HSI        STM32_SW_HSI
#define RCC_CFGR1_SW_CSI        STM32_SW_CSI
#define RCC_CFGR1_SW_HSE        STM32_SW_HSE
#define RCC_CFGR1_SW_PLL1P      STM32_SW_PLL1P
...
#define RCC_CFGR1_SWS_FIELD     STM32_SWS_FIELD
#define RCC_CFGR1_SWS_HSI       STM32_SWS_HSI
#define RCC_CFGR1_SWS_CSI       STM32_SWS_CSI
#define RCC_CFGR1_SWS_HSE       STM32_SWS_HSE
#define RCC_CFGR1_SWS_PLL1P     STM32_SWS_PLL1P
 ...
 */
#if !defined(__STM32H5xx_XMCUCONF__)
#error "Using a wrong mcuconf.h file, __STM32H5xx_XMCUCONF__ not defined"
#endif

#if defined(STM32H503xx) && !defined(__STM32H503_XMCUCONF__)
#error "Using a wrong mcuconf.h file, __STM32H503_XMCUCONF__ not defined"

#elif defined(STM32H562xx) && !defined(__STM32H562_XMCUCONF__)
#error "Using a wrong mcuconf.h file, __STM32H562_XMCUCONF__ not defined"

#elif defined(STM32H563xx) && !defined(__STM32H563_XMCUCONF__)
#error "Using a wrong mcuconf.h file, __STM32H563_XMCUCONF__ not defined"

#elif defined(STM32H573xx) && !defined(__STM32H573_XMCUCONF__)
#error "Using a wrong mcuconf.h file, __STM32H573_XMCUCONF__ not defined"

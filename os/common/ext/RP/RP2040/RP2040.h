 ...
 *
 * @file     /home/ske/Development/qmk_firmware/lib/chibios/os/common/ext/RP/RP2040/sources/../RP2040.h
 * @brief    CMSIS HeaderFile
 * @version  0.1
 * @date     Wed Sep  4 13:15:39 2024
 * @note     Generated by SVDConv V3.3.47
 *           from File '/home/ske/Development/qmk_firmware/lib/chibios/os/common/ext/RP/RP2040/sources/RP2040.svd.patched',
 *           last modified on Wed Sep  4 13:13:56 2024
 */
...
/**
  ...
  */
typedef struct {
  __IOM uint32_t  GPIO_STATUS;                  /*!< GPIO status                                                               */
  __IOM uint32_t  GPIO_CTRL;                    /*!< GPIO control including function select and overrides.                     */
...
typedef struct {                                /*!< IO_BANK0 Structure                                                        */
  __IOM IO_BANK0_GPIO_Type GPIO[30];            /*!< Cluster GPIO, containing GPIO*_STATUS, GPIO*_CTRL                         */
...
typedef struct {                                /*!< DMA Structure                                                             */
  __IOM DMA_CH_Type CH[12];                     /*!< Cluster CH, containing CH?_READ_ADDR,CH??_READ_ADDR, CH?_WRITE_ADDR,CH??_WRITE
...
/**
  * @brief Controls time and alarms 
            ...
            To clear the interrupt write a 1 to the corresponding alarm_irq (TIMER0)
  */
...
typedef struct {                                /*!< PWM Structure                                                             */
  __IOM PWM_CH_Type CH[8];                      /*!< Cluster CH, containing CH*_CC, CH*_CSR, CH*_CTR, CH*_DIV, CH*_TOP         */
...
typedef struct {                                /*!< USB_DPRAM Structure                                                       */
  ...
  __IOM uint32_t  EP_CONTROL[30];               /*!< -                                                                         */
  __IOM uint32_t  EP_BUFFER_CONTROL[32];        /*!< -                                                                         */
  __IOM uint32_t  EPX_CONTROL;                  /*!< EPx Control (Host-mode only!)                                             */
} USB_DPRAM_Type;                               /*!< Size = 260 (0x104)                                                        */
...
#define TIMER0_BASE                 0x40054000UL

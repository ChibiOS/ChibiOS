...
#define MPU_MAIR0_ATTR1_MASK                ((uint32_t)0xFFU << 8)
#define MPU_MAIR0_ATTR1(n)                  ((uint32_t)(n) << 8)
#define MPU_MAIR0_ATTR2_MASK                ((uint32_t)0xFFU << 16)
#define MPU_MAIR0_ATTR2(n)                  ((uint32_t)(n) << 16)
#define MPU_MAIR0_ATTR3_MASK                ((uint32_t)0xFFU << 24)
#define MPU_MAIR0_ATTR3(n)                  ((uint32_t)(n) << 24)

#define MPU_MAIR1_ATTR4_MASK                ((uint32_t)0xFFU << 0)
#define MPU_MAIR1_ATTR4(n)                  ((uint32_t)(n) << 0)
#define MPU_MAIR1_ATTR5_MASK                ((uint32_t)0xFFU << 8)
#define MPU_MAIR1_ATTR5(n)                  ((uint32_t)(n) << 8)
#define MPU_MAIR1_ATTR6_MASK                ((uint32_t)0xFFU << 16)
#define MPU_MAIR1_ATTR6(n)                  ((uint32_t)(n) << 16)
#define MPU_MAIR1_ATTR7_MASK                ((uint32_t)0xFFU << 24)
#define MPU_MAIR1_ATTR7(n)                  ((uint32_t)(n) << 24)
/** @} */

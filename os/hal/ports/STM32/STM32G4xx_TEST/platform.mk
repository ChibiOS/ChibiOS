...
PLATFORMSRC := $(CHIBIOS)/os/hal/ports/common/ARMCMx/nvic.c \
               $(CHIBIOS)/os/hal/ports/STM32/STM32G4xx_TEST/stm32_isr.c \
               $(CHIBIOS)/os/hal/ports/STM32/STM32G4xx_TEST/hal_lld.c \
               $(CHIBIOS)/os/hal/ports/STM32/STM32G4xx_TEST/hal_efl_lld.c

# Required include directories.
PLATFORMINC := $(CHIBIOS)/os/hal/ports/common/ARMCMx \
               $(CHIBIOS)/os/hal/ports/STM32/STM32G4xx_TEST

...
#if ((STM32_FLASH_ACR & STM32_ACR_LPM) == 0) || defined(__DOXYGEN__)
 ...
 * @{
 */
#if ((STM32_PWR_VOSR & STM32_VOSR_RANGE_MASK) == STM32_VOSR_RANGE1) || defined(__DOXYGEN__)
...
#elif (STM32_PWR_VOSR & STM32_VOSR_RANGE_MASK) == STM32_VOSR_RANGE2

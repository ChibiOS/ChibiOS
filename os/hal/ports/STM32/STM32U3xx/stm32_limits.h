 ...
 * @{
 */
#define STM32_RANGE1_SYSCLK_MAX         960000000
#define STM32_RANGE1_HSECLK_MAX         500000000
#define STM32_RANGE1_HSECLK_BYP_MAX     500000000
#define STM32_RANGE1_HSECLK_MIN         40000000
#define STM32_RANGE1_HSECLK_BYP_MIN     40000000
...
#define STM32_RANGE1_PCLK1_MAX          96000000
#define STM32_RANGE1_PCLK2_MAX          96000000
#define STM32_RANGE1_PCLK3_MAX          96000000
#define STM32_RANGE1_ADCCLK_MAX         55000000

#if ((STM32_FLASH_ACR & STM32_FLASH_ACR_LPM) == 0) || defined(__DOXYGEN__)
#define STM32_RANGE1_0WS_THRESHOLD      32000000
#define STM32_RANGE1_1WS_THRESHOLD      64000000
#define STM32_RANGE1_2WS_THRESHOLD      960000000
...
#define STM32_RANGE1_2WS_THRESHOLD      600000000
#define STM32_RANGE1_3WS_THRESHOLD      800000000
#define STM32_RANGE1_4WS_THRESHOLD      960000000
#endif
/** @} */
 ...
 * @{
 */
#define STM32_RANGE2_SYSCLK_MAX         480000000
#define STM32_RANGE2_HSECLK_MAX         480000000
#define STM32_RANGE2_HSECLK_BYP_MAX     480000000
#define STM32_RANGE2_HSECLK_MIN         40000000
#define STM32_RANGE2_HSECLK_BYP_MIN     40000000
...
#define STM32_RANGE1_PCLK1_MAX          48000000
#define STM32_RANGE1_PCLK2_MAX          48000000
#define STM32_RANGE1_PCLK3_MAX          48000000
#define STM32_RANGE2_ADCCLK_MAX         48000000

#if ((STM32_FLASH_ACR & STM32_FLASH_ACR_LPM) == 0) || defined(__DOXYGEN__)
#define STM32_RANGE2_0WS_THRESHOLD      16000000
#define STM32_RANGE2_1WS_THRESHOLD      32000000
#define STM32_RANGE2_2WS_THRESHOLD      480000000
 ...
 * @{
 */
#if ((STM32_PWR_VOS & STM32_VOS_MASK) == STM32_VOS_RANGE1) || defined(__DOXYGEN__)
...
#elif (STM32_PWR_VOS & STM32_VOS_MASK) == STM32_VOS_RANGE2

 ...
 * @isr
 */
OSAL_IRQ_HANDLER(RP_TIMER0_IRQ0_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(RP_TIMER0_IRQ1_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(RP_TIMER0_IRQ2_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(RP_TIMER0_IRQ3_HANDLER) {
...
#if OSAL_ST_MODE == OSAL_ST_MODE_FREERUNNING
  nvicEnableVector(RP_TIMER0_IRQ0_NUMBER, RP_IRQ_TIMER_ALARM0_PRIORITY);
#endif
#if OSAL_ST_MODE == OSAL_ST_MODE_PERIODIC

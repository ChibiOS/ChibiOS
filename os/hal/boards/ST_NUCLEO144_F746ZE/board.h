 ...
 * PA15 - ZIO_D20 I2S3_WS           (alternate 8).
 */
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_ZIO_D32) |       \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOA_ARD_D11) |    \
 ...
 * PC7  - ZIO_D21 I2S3_MCK          (alternate 5).
 ...
 * PG14 - ARD_D1 USART6_TX          (alternate 11).

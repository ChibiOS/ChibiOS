 ...
 * PA2  - ARD_D1                    (analog).
 * PA3  - ARD_D0                    (analog).
 * PA4  - ARD_D10A ADC1_IN9         (analog).
 * PA5  - ARD_D13  ADC1_IN10        (analog).
 * PA6  - ARD_D12  ADC1_IN11        (analog).
 * PA7  - ARD_D11  ADC1_IN12        (analog).
 * PA8  - ARD_D6   ADC1_IN15        (analog).
 * PA9  - ARD_D9   ADC1_IN16        (analog).
 * PA10 - ARD_D3                    (analog).
 ...
 * PB4  - PIN4                      (analog).
 * PB5  - PIN5 LD1 (BLUE)           (output pushpull maximum).
 * PB6  - PIN6 USART1_TX            (alternate 7).
 * PB7  - PIN7 USART1_RX            (alternate 7).
 * PB8  - ARD_D15                   (analog).
 * PB9  - ARD_D14                   (analog).
 * PB10 - ARD_D10B                  (analog).
 * PB11 - PIN11                     (analog).
 * PB12 - PIN12                     (analog).
 * PB13 - PIN13                     (analog).
 * PB14 - PIN14                     (analog).
 ...
 * PC2  - PIN2                      (analog).
 * PC3  - PIN3                      (analog).
 * PC4  - PIN4 B1 (BUTTON)          (input pullup).
 * PC5  - PIN5                      (analog).
 * PC6  - PIN6                      (analog).
 * PC7  - PIN7                      (analog).
 * PC8  - PIN8                      (analog).
 ...
 * GPIOD setup:
 *
 * PD0  - PIN0 B2 (BUTTON)          (input pullup).
 * PD1  - PIN1 B3 (BUTTON)          (input pullup).
 * PD2  - PIN2                      (analog).
 * PD3  - PIN3                      (analog).
 * PD4  - PIN4                      (analog).
 * PD5  - PIN5                      (analog).

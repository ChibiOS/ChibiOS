...
/**
 * @file    httpd_vfs.h
 * @brief   HTTPD VFS bindings macros and structures.
...
/**
 * @brief   HTTPD-visible root path inside the VFS namespace.
 */
#if !defined(HTTPD_VFS_PREFIX) || defined(__DOXYGEN__)
#define HTTPD_VFS_PREFIX                  "/"
#endif

...
ili9341WriteByte(lcdp, 0x00);
ili9341WriteByte(lcdp, 0x18);// Частота кадров 79 Гц
chThdSleepMilliseconds(5);
...
chThdSleepMilliseconds(5);
ili9341WriteCommand(lcdp,ILI9341_SET_PAGE_ADDR); // Page Address Set
ili9341WriteByte(lcdp,0x00);
ili9341WriteByte(lcdp,0x00);
ili9341WriteByte(lcdp,0x01);
ili9341WriteByte(lcdp,0x3F);
ili9341WriteCommand(lcdp,ILI9341_SET_COL_ADDR); // Column Address Set
ili9341WriteByte(lcdp,0x00);
ili9341WriteByte(lcdp,0x00);
ili9341WriteByte(lcdp,0x00);
...
for (size_t i = 0; i < 2*X_SIZE*Y_SIZE; i++)
{
  ili9341WriteByte(lcdp,0xF8);
  ili9341WriteByte(lcdp,0x00);
}

*****************************************************************************
** ChibiOS/RT port for ARM-Cortex-M3 STM32F103 on STM32 Blue Pill boards   **
*****************************************************************************

** TARGET **

The demo runs on the Blue Pill with the original MapleMini bootloader.
...
To flash the firmware to the Blue Pill, you can use dfu-util. While the Blue Pill 
is connected via USB and still in bootloader mode, just run
